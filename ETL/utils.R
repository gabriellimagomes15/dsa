...
packages <- c("rvest","plyr","data.table","tm","stringr","stringdist","dplyr","tidytext","bit64")
...
scrapJobsVac <- function(pageJob = '', id = 'ni', tagPosit= 'ni', tagCompany= 'ni', tagCityState= 'ni', tagDate= 'ni', 
  ...
  data <- data.frame(id, positJob, company, city_state, date, descrip, dateColect, country = country, url = url)
